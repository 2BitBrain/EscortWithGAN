...
if __name__ == "__main__":
    ...
    parser.add_argument("--p_itrs", dest="p_itrs", type=int, default=2001)
    ...
    parser.add_argument("--vocab_size", dest="vocab_size", type=int, default=53014)
    parser.add_argument("--train", dest="train", type=bool, default=True)
    parser.add_argument("--keep_prob", dest="keep_prob", type=float, default=0.3)
    parser.add_argument("--gen_rnn_size", dest="gen_rnn_size", type=int, default=328)
    parser.add_argument("--dis_rnn_size", dest="dis_rnn_size", type=int, default=328)
